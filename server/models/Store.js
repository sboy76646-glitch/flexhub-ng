...
const storeSchema = new mongoose.Schema(
  {
    ...
    verificationLevel: {
      type: String,
      enum: ["unverified", "basic", "verified", "premium", "bronze", "silver", "gold", "platinum"],
      default: "unverified",
      index: true,
    },
    ...
    performance: {
      ...
      verifiedReviewCount: { type: Number, min: 0, default: 0 },
      productMatchRate: { type: Number, min: 0, max: 100, default: 0 },
    },
...
storeSchema.index({ status: 1, verified: 1, createdAt: -1 });
